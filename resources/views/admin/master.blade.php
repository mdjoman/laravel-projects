...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul style="z-index: 999;" class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">BDSHOP Dashboard </div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{route('add-categories')}}">Add Categories</a>
                        <a class="collapse-item" href="{{route('manage-categories')}}">Manage Categories</a>
                    </div>
                </div>
            </li>
            <hr class="sidebar-divider">
            ...
            <li class="nav-item">
            <a class="nav-link" href="{{route('manage-order')}}"> <i class="fas fa-fw fa-cog"></i>Manage Order</a>      
            </li>
            <!-- Divider -->
            <hr class="sidebar-divider">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="{{ asset('/') }}admin-style/img/undraw_profile_1.svg"
                                            alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="{{ asset('/') }}admin-style/img/undraw_profile_2.svg"
                                            alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="{{ asset('/') }}admin-style/img/undraw_profile_3.svg"
                                            alt="...">
    ...
    <script src="{{ asset('/') }}admin-style/js/demo/chart-area-demo.js"></script>
    <script src="{{ asset('/') }}admin-style/js/demo/chart-pie-demo.js"></script>
