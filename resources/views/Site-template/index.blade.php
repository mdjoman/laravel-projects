          ...
          <div class="carousel-item active">
            <div class="container ">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="img-box">
                    <img src="{{ asset('/') }}style-file/images/slider-img.png" alt="">
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="container-fluid  ">
      <div class="row">
        ...
        <div class="col-md-6 px-0">
          <div class="img-box">
            <img src="{{ asset('/') }}style-file/images/about-img.jpg" alt="">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="box ">
            <div class="img-box">
              <img src="{{ asset('/') }}style-file/images/w1.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Fast Delivery
        ...
        <div class="col-md-4">
          <div class="box ">
            <div class="img-box">
              <img src="{{ asset('/') }}style-file/images/w2.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Free Shiping
        ...
        <div class="col-md-4">
          <div class="box ">
            <div class="img-box">
              <img src="{{ asset('/') }}style-file/images/w3.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Best Quality
          ...
          <div class="carousel-item active">
            <div class="container">
              <div class="box">
                ...
                <div class="client-id">
                  <div class="img-box">
                    <img src="{{ asset('/') }}style-file/images/client.jpg" alt="">
                  </div>
                  <div class="name">
                    <h5>
                      James Dew
